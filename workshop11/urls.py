...
urlpatterns = patterns('',
    ...
    #url(r'^work_ktj_202901$','workshop1.views.work1',name='index'),
    ...
    url(r'^work_ktj_983472$','workshop11.views.work11',name='index'),

    url(r'^login$',csrf_exempt(views.login),name='login'),
    url(r'^logout$','workshop11.views.logout_workshop', name='logour'),
)
